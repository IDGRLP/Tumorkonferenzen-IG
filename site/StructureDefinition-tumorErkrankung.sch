...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:EpisodeOfCare/f:diagnosis/f:role</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:EpisodeOfCare/f:diagnosis/f:role/f:coding</sch:title>
    <sch:rule context="f:EpisodeOfCare/f:diagnosis/f:role/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
